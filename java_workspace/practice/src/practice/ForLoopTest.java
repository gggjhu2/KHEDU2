...
public class ForLoopTest {
	...
	public static void main(String[] args) {
		...
		ForLoopTest ft = new ForLoopTest();
		...
		public void test1() {
			...
			switch(num){
				...
				price =1000;
				break;
				case 2 : System.out.println("김밥은  2000원입니다.");
				price =2000;
				break;
				case 3 : System.out.println("오뎅은  1000원입니다.");
				price =1000;
				break;
				case 4 : System.out.println("순대은  2000원입니다.");
				price =2000;
				break;
				case 5 : System.out.println("튀김은  3000원입니다.");
				price =3000;
				break;
				case 6 : System.out.println("떡튀순은  8000원입니다.");
				price =8000;
				break;
